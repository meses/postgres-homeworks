...
select ship_city, ship_country from orders o
...
select country, count(*) as suppliers_count  from suppliers s
group by country
...
select ship_country, sum(freight) as summ from orders o
